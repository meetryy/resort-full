...
#       endif //IMGUI_USE_MINIZIP
    ...
    I.dirs.clear();I.files.clear();I.dirNames.clear();I.fileNames.clear();I.currentSplitPath.clear();I.fileExtensionTypes.clear();
        ...
        if (!windowTitle || strlen(windowTitle)==0)  {
            ...
            else if (isSaveFileDialog)  strcpy(I.wndTitle,u8"Сохранить");
            else                        strcpy(I.wndTitle,u8"Открыть");
        }
...
#           endif //SIMULATING_ONLY
    ...
    ImGui::Separator();
    // sorting --------------------------------------------------------------------
    ImGui::Text(u8"Сортировать по: ");ImGui::SameLine();
    {
        ...
        //-----------------------------------------------------
        {
            ...
            static const char* names[numTabs] = {u8"Имя",u8"Дата",u8"Размер",u8"Тип"};
